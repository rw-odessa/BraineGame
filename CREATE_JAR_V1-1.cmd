...
IF EXIST %FILES_PATH%Progect.jar DEL /Q %FILES_PATH%Progect.jar|| ECHO %date% %time% - ERROR DELETE %FILES_PATH%Progect.jar

REM==================================================
REM Обработаем файл MANIFEST.MF
SET "MANIFEST-FILE="
SET "MANIFEST="
IF EXIST %FILES_PATH%MANIFEST.MF (
SET "MANIFEST-FILE= MANIFEST.MF"
SET MANIFEST=m
)
...
"C:\Program Files\Java\jdk1.7.0_21\bin\jar.exe" cfv%MANIFEST% Progect.jar%MANIFEST-FILE% %NAME% || (
